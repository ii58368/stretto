...
// field: status
   ...
   public $per_stat_removed = 7;
   public $per_stat = array("Sluttet", "Medlem", "Vikar", "Innleid", "Engasjert", "Søkt", "Ekstra", "Slettet");
// field: sex
   public $per_sex_unknown = 0;
   public $per_sex_male = 1;
   public $per_sex_female = 2;
   public $per_sex = array("Ukjent", "Mann", "Kvinne");
   public $per_sex2 = array("Unknown", "Male", "Female");
// field: fee
...
// table: record
   ...
   public $rec_stat_mr = 1;
   public $rec_stat_board = 2;
   public $rec_stat = array("Info", "For MR", "For styret");
// table: feedback
